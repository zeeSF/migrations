CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_PriceHistoricalMonthly
AS
SELECT a.Date,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_ROFO
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_STOCK_OUT
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_TICK_ANY
AS
SELECT fecha as Fecha
,
codigo_SAP_cliente_antiguo as "Código_de_Expendeduria_Logista"
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_TICK_ALL
AS
SELECT fecha as Fecha
,
codigo_SAP_cliente_antiguo as "Código_de_Expendeduria_Logista"
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_TICK_SKU
AS
SELECT fecha as Fecha
,
codigo_SAP_cliente_antiguo as "Código_de_Expendeduria_Logista"
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_WSALES
AS
SELECT fecha as Fecha,
mercado as Mercado_Logista,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SO_WSALES_SEG
AS
SELECT fecha as Fecha
,
mercado as Mercado_Logista
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCounty
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyDataset
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyComis
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyFZ
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyFZDataset
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyStocks
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCustomer AS
SELECT
  s.logista_product_code as Logista_Code,
  sku.SKU_product_code as SKU_Code,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyUser
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesMonthCustomer
AS
SELECT s.logista_product_code as Logista_Code,
license_code as License_Code,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SellOut
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SellOut040
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_Product AS
SELECT
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_Stocks
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_isms_Geo
AS
/*
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_Horarios_POS_iSMS AS
SELECT
  RegionCode,
  Zonecode,
  TerritoryCode,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_MaestroProductos
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_MaestroSWAP
AS
SELECT SPICE_ID,
Case_Number,
Date_Time_Opened,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_MaestroMonthlyOverview AS
SELECT
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_SellOut_vPriceHistorical
AS
SELECT a.Date,
a.sku_product_code as SKU_Code,
a.price as Price_Historical,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_SellOut_vproduct
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_DCECheckDuplicates
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_Calendar
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_County
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_IMS_Sales_PBI
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_GIT
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_Customer AS
SELECT
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_LogistaStores
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_es_customer_sales_pbi AS
SELECT
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_Obj
AS
SELECT s.SKU_product_code,
s.sales_date,
s.sales_qty as Sales_Qty,
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_PANEL
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_PriceHistorical
AS
...
CREATE VIEW  IF NOT EXISTS $${db}.DATA_PRODUCT.v_sims_SalesDayCountyReport
AS
